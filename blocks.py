...
class Block():
    ...
    def __init__(self, position=(0, 0, 0), color=(1, 1, 1, 1)):
        ...
        # установите на узел collisionNode маску проверки столкновений ДО
        # такую же, как и у луча выделения в Editor
        collisionNode.setIntoCollideMask(BitMask32.bit(1))
        # установите на узел collisionNode тег 'key' со значением уникального ключа self.key
        # чтобы потом определить что именно мы выделили
